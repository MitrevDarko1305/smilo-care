...
/**
 * Drop-in section: just import and render <FeaturesSection />.
 */
  ...
  const features = [
    {
      ...
      description:
      "Routine check-ups, cleanings, and preventive care for long-term oral health",
      href: "/services",
      icon: Stethoscope,
    },
    {
      ...
      description:
      "Threatments designed to enhance the appearance of your smile with natural results",
      href: "#services",
      icon: Smile,
    },
    {
      title: "Orthodontics",
      description:
      "Modern solutions to align teeth and improve bite for all ages",
      href: "/services",
      icon: AlignCenter,
    },
  ] as const;
    ...
    <section className="bg-foreground py-24 sm:py-22">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl lg:mx-0">
         <RevealOnScroll>
          <h2 className="text-white/50 font-medium leading-7 text-white">
            Dental treatments tailored to your needs.
          </h2>
          </RevealOnScroll>
          <RevealOnScroll>
          <p className="mt-2  text-[45px] font-medium mb-4 text-white">
              ...
              return (
                ...
                <div className="flex flex-col">
                 <RevealOnScroll>
                  ...
                  <RevealOnScroll>
                  <dd className="mt-3 flex flex-auto flex-col text-base leading-7 text-white/50">
                    ...
                    <p className="mt-10">
                     <Link
                      href={f.href}
                      className="inline-flex items-center gap-x-1 text-white hover:text-primary font-semibold text-white"
                      >
                    View treatment
